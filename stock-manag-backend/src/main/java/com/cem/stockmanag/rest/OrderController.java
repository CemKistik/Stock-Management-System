...
import com.cem.stockmanag.mapper.OrderMapper;
...
import com.cem.stockmanag.security.CustomUserDetails;
import com.cem.stockmanag.service.OrderService;
import com.cem.stockmanag.service.UserService;

import javax.validation.Valid;

import static com.cem.stockmanag.config.SwaggerConfig.BEARER_KEY_SECURITY_SCHEME;
...
public class OrderController {
    ...
    @PutMapping("/{id}")
    public OrderDto updateOrders(@PathVariable UUID id) {
        Order order = orderService.validateAndGetOrder(id.toString());
